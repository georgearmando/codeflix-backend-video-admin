...
describe("CategorySequelizeRepository Integration Tests", () =>{
  ...
  it("shold insert a new category", async () => {
  ...
  it("should find a category by id", async () => {
    ...
    expect(category.toJSON()).toStrictEqual(categoryFounded.toJSON());
  });
  ...
  it("should return all categories", async () => {
    ...
    expect(allCategories).toStrictEqual(categories);
  ...
  it("should update a category", async () => {
    ...
    const categoryFounded = await repository.findById(category.category_id);
    expect(category.toJSON()).toStrictEqual(categoryFounded.toJSON());
  });

  it("should throw error on delete when a category is not found", async () => {
    const category_id = new Uuid();
    await expect(repository.delete(category_id)).rejects.toThrowError(
